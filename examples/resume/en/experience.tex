...
%---------------------------------------------------------
  \cventry
    {DevOps/CloudOps Engineer} % Job title
    {ImpressSol GmbH} % Organization
    {Remote, Germany} % Location
  ...
  \cventry
    ...
    {Mercedes-Benz Tech Innovation} % Organization
    {Stuttgart, Germany} % Location
    {March 2022 - March 2023} % Date(s)
    {
      \begin{cvitems} % Description(s) of tasks/responsibilities
